...
void set_control_words(void *keys, const unsigned char *ev, const unsigned char *od){
  schedule_key(&((struct csa_keys_t *)keys)->even,ev,0);
  schedule_key(&((struct csa_keys_t *)keys)->odd,od,0);
}

void set_even_control_word(void *keys, const unsigned char *pk, const unsigned char ecm){
  schedule_key(&((struct csa_keys_t *)keys)->even,pk,ecm);
}

void set_odd_control_word(void *keys, const unsigned char *pk, const unsigned char ecm){
